...
def isWinner(bo, le):
    ...
    # we use bo instead of board and le instead of letter so we don't have to type to much.
...
def getComputerMove(board, computerLetter):
    # given a board and the computer letter's, determine where to move and return that move.
    if computerLetter == 'X':
        playLetter = 'O'
    else:
        playLetter = 'X'
            ...
            if isWinner(theBoard, playerLetter):
                ...
                while gameIsPlaying:
                    if turn == 'player':
                        ...
                        #Computer's turn.
                        move = getComputerMove(theBoard, computerLeeter)
